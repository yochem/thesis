...
in the world'\footnotemark, \citeA{russell2010}. Their explanation of \rl is
...
first scheduler is DeepRM, presented in \citeA{mao2016}. This scheduler is
...
using the REINFORCE algorithm from \citeA{sutton1999}. For the state
representation, a 2-D image is used to capture the status of resources and
jobs. The second state-of-the-art scheduler is proposed in \citeA{zhang2020}
...
\citeA{zhang2020} is not hard bounded by the instance size
...
for evaluating \rl in \citeA{khetarpal2018} and a novel evaluation method in
